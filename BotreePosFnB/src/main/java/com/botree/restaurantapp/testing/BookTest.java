...
class Banner implements Printable
{
   ...
   public int print(Graphics g, PageFormat pf, int page) throws PrinterException
   {
		...
		System.out.println(" page count: " + page + " pageFormat: " +  pf +  " graphics: " + g.hashCode());

	   Graphics2D g2 = (Graphics2D) g;
      System.out.println(" c =  " + getPageCount(g2, pf));
      
      if (page > getPageCount(g2, pf)) return Printable.NO_SUCH_PAGE;
      
      g2.translate(pf.getImageableX(), pf.getImageableY());
      System.out.println(pf.getImageableX() + "  translate  " + pf.getImageableY() );
   ...
   public void drawPage(Graphics2D g2, PageFormat pf, int page)
   {
      ...
      System.out.println( "translate inside  " + page * pf.getImageableWidth() );
      System.out.println(scale);
      g2.scale(scale, scale);
      FontRenderContext context = g2.getFontRenderContext();
      Font f = new Font("Serif", Font.PLAIN, 300);
...
class CoverPage implements Printable
{
   ...
   public int print(Graphics g, PageFormat pf, int page) throws PrinterException
   {
	   System.out.println(" c-- page count: " + page + " pageFormat: " +  pf +  " graphics: " + g.hashCode());
